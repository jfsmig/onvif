...
func Call_GetAudioDecoderConfigurationOptions(ctx context.Context, dev *device.Device, request GetAudioDecoderConfigurationOptions) (GetAudioDecoderConfigurationOptionsResponse, error) {
