...
func Call_AddAudioSourceConfiguration(ctx context.Context, dev *device.Device, request AddAudioSourceConfiguration) (AddAudioSourceConfigurationResponse, error) {
