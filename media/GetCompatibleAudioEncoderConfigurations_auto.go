...
func Call_GetCompatibleAudioEncoderConfigurations(ctx context.Context, dev *device.Device, request GetCompatibleAudioEncoderConfigurations) (GetCompatibleAudioEncoderConfigurationsResponse, error) {
