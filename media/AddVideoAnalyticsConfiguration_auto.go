...
func Call_AddVideoAnalyticsConfiguration(ctx context.Context, dev *device.Device, request AddVideoAnalyticsConfiguration) (AddVideoAnalyticsConfigurationResponse, error) {
