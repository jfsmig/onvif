...
func Call_GetVideoEncoderConfiguration(ctx context.Context, dev *device.Device, request GetVideoEncoderConfiguration) (GetVideoEncoderConfigurationResponse, error) {
