...
func Call_GetCompatibleMetadataConfigurations(ctx context.Context, dev *device.Device, request GetCompatibleMetadataConfigurations) (GetCompatibleMetadataConfigurationsResponse, error) {
