...
func Call_AddVideoSourceConfiguration(ctx context.Context, dev *device.Device, request AddVideoSourceConfiguration) (AddVideoSourceConfigurationResponse, error) {
