...
func Call_GetCompatibleAudioOutputConfigurations(ctx context.Context, dev *device.Device, request GetCompatibleAudioOutputConfigurations) (GetCompatibleAudioOutputConfigurationsResponse, error) {
