...
func Call_GetAudioEncoderConfigurationOptions(ctx context.Context, dev *device.Device, request GetAudioEncoderConfigurationOptions) (GetAudioEncoderConfigurationOptionsResponse, error) {
