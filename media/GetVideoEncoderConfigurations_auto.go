...
func Call_GetVideoEncoderConfigurations(ctx context.Context, dev *device.Device, request GetVideoEncoderConfigurations) (GetVideoEncoderConfigurationsResponse, error) {
