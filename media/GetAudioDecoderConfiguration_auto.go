...
func Call_GetAudioDecoderConfiguration(ctx context.Context, dev *device.Device, request GetAudioDecoderConfiguration) (GetAudioDecoderConfigurationResponse, error) {
