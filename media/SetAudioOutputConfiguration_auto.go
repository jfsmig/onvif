...
func Call_SetAudioOutputConfiguration(ctx context.Context, dev *device.Device, request SetAudioOutputConfiguration) (SetAudioOutputConfigurationResponse, error) {
