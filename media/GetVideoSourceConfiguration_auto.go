...
func Call_GetVideoSourceConfiguration(ctx context.Context, dev *device.Device, request GetVideoSourceConfiguration) (GetVideoSourceConfigurationResponse, error) {
