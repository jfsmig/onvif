...
func Call_GetCompatibleVideoAnalyticsConfigurations(ctx context.Context, dev *device.Device, request GetCompatibleVideoAnalyticsConfigurations) (GetCompatibleVideoAnalyticsConfigurationsResponse, error) {
