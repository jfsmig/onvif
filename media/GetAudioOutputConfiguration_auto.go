...
func Call_GetAudioOutputConfiguration(ctx context.Context, dev *device.Device, request GetAudioOutputConfiguration) (GetAudioOutputConfigurationResponse, error) {
