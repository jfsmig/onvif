...
func Call_GetAudioOutputs(ctx context.Context, dev *networking.Client, request GetAudioOutputs) (GetAudioOutputsResponse, error) {
	...
	if err != nil {
		...
		err = networking.ReadAndParse(httpReply, &reply, "GetAudioOutputs")
		return reply.Body.GetAudioOutputsResponse, err
	}
}
