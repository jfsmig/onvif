...
func Call_GetAudioSourceConfigurationOptions(ctx context.Context, dev *device.Device, request GetAudioSourceConfigurationOptions) (GetAudioSourceConfigurationOptionsResponse, error) {
