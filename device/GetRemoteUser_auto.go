...
func Call_GetRemoteUser(ctx context.Context, dev *networking.Client, request GetRemoteUser) (GetRemoteUserResponse, error) {
	...
	if err != nil {
		...
		err = networking.ReadAndParse(httpReply, &reply, "GetRemoteUser")
		return reply.Body.GetRemoteUserResponse, err
	}
}
